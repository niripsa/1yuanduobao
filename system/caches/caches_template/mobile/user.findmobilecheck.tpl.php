...
<section>
    <form action="<?php echo WEB_PATH; ?>/member/finduser/findmobilecheck/<?php echo $namestr; ?>" method="post" id="registerform">
        <div class="registerCon">
            <ul>
                <p>已向您的手机 <span class="orange"><?php echo $enname; ?></span> 免费发送了一条验证短信，请查看您的手机短信！</p>
                <li>
                    <dl>
                        请输入手机短信收到的验证码：<input id="mobileCode" name="checkcode" class="login_CMobile_Code" type="text">
                        <input type="hidden" name="ok" value="ok">
                        <s class="rs3"></s>
                    </dl>
                </li>
                <li><a id="btnLogin" class="nextBtn orgBtn">提交验证</a>
                   </li>
                <li >
                    <h2>没收到验证短信？</h2>
