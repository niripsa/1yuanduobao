...
<section class="clearfix g-member">
    <div class="m-round m-member-nav">
        <ul>    
            <li>1元就能中大奖哦，快去邀请好友来购买吧！</li>
            <img src="http://qr.topscan.com/api.php?text=<?php echo WEB_PATH; ?>/register/<?php echo $uid; ?>/<?php echo $area_id; ?>" />
            <!-- <li class="invite"><?php echo WEB_PATH; ?>/register/<?php echo $uid; ?>/<?php echo $area_id; ?></li> -->
            <!-- <li>
                <input id="txtInfo" style="width:818px;height:20px; " disabled="disabled" value="" onpaste="return false" type="text">
            </li> -->
        </ul>
