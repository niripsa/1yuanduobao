    ...
    <div class="submitted">
        <ul class="order">
            <li class="top">
                ...
                <span class="num" style="width:190px"><?php echo L('html.key'); ?>人次</span>
            ...
            <li class="end" id="shoplist<?php echo $shops['id']; ?>">
                <span class="goods">
                    <a href="<?php echo WEB_PATH; ?>/cgoods/<?php echo $shops['id']; ?>">
                     <img src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $shops['g_thumb']; ?>" />
                    </a>                    
                </span>
                <span class="name">
                    <a href="<?php echo WEB_PATH; ?>/cgoods/<?php echo $shops['id']; ?>" ><?php echo $shops['g_title']; ?></a>
                    <p>总需 <span class="color"><?php echo $shops['zongrenshu']; ?></span>人次参与，还剩 
                           <span class="gorenci"><?php echo $shops['cart_shenyu']; ?></span> 人次
                    </p>
                </span>
                <span class="moneys"><?php echo $shops['g_money']; ?><?php echo L('cgoods.currency'); ?></span>
                <span class="money"><span class="color"><b><?php echo $shops['price']; ?></b></span>  <?php echo L('cgoods.currency'); ?></span>
                <span class="num">              
                    <dl class="add">                    
                    ...
                    <p class="message"></p>
                   <a   href="JavaScript:;" class="shop_last_all"  val="<?php echo $shops['id']; ?>" ><?php echo L('cgoods.last'); ?></a>    
                </span>             
                <span  class="xj"><?php echo $shops['cart_xiaoji']; ?></span>
                <span class="do"><a href="javascript:;" onclick="delcartlist(<?php echo $shops['id']; ?>)"  class="delgood">删除</a></span> 
            </li>       
            <?php endforeach; ?>           
            <li class="ts">
                <p class="right"><?php echo L('html.key'); ?><?php echo L('cgoods.sum.num'); ?>:<span id="moenyCount"><?php echo $MoenyCount; ?></span>  <?php echo L('cgoods.currency'); ?></p>
            </li>
        </ul>
    </div>
    <h5>
        <a href="<?php echo WEB_PATH; ?>"  id="but_on"><span>返回继续夺宝</span></a>
