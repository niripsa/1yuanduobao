...
function show_date_time_location()
{
    window.setTimeout( function() {
        ...
        $.post("<?php echo WEB_PATH; ?>/index/getshop/lottery_shop_set/",{"lottery_sub":"true","gid":<?php echo $item['id']; ?>},null);
        window.setTimeout(function(){window.location.href="<?php echo WEB_PATH; ?>/cgdataserver/<?php echo $item['id']; ?>";},5000);
    }, 1000 );
}
...
$( function() {
    ...
    $.post("<?php echo WEB_PATH; ?>/index/getshop/lottery_shop_get",{"lottery_shop_get":true,"gid":<?php echo $item['id']; ?>,"times":Math.random()},function(sdata){
