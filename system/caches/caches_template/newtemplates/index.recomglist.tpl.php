...
<div class="wrap w1200">
    <div class="Current_nav w1200"><a href="<?php echo WEB_PATH; ?>/recomgoods_list/">首页</a> &gt;  <?php echo $daohang_title; ?></div>
    <div class="list_Curtit b_gray">
        <a href="<?php echo WEB_PATH; ?>/recomgoods_list/<?php echo $cid; ?>_0_0" ><h1 class="fl c_red"><?php echo $daohang_title; ?></h1></a>
        ...
        <dl>
            ...
            <dd id="ddBrandList">
                ...
                <?php if(isset($daohang['parentid'])): ?>             
                    <li><a href="<?php echo WEB_PATH; ?>/recomgoods_list/<?php echo $daohang['parentid']; ?>_0_0" >全部</a></li>
                <?php  else: ?>
                    <li><a href="<?php echo WEB_PATH; ?>/recomgoods_list/<?php echo $cid; ?>_0_0" class="ClassCur bg_red">全部</a></li>
                <?php endif; ?>
                <?php if(is_array(GetCate('0',50,5))) foreach(GetCate('0',50,5) AS $two_cate): ?>
                    ...
                    <li><a href="<?php echo WEB_PATH; ?>/recomgoods_list/<?php echo $two_cate['cateid']; ?>_0_0"  class="ClassCur bg_red"><?php echo $two_cate['name']; ?></a></li>
                    <?php  else: ?>
                    <?php if($cateid): ?>
                    ...
                    <?php endforeach; ?>
                    <?php endif; ?>
                    <li><a href="<?php echo WEB_PATH; ?>/recomgoods_list/<?php echo $two_cate['cateid']; ?>_0_0"><?php echo $two_cate['name']; ?></a></li>
                    <?php endif; ?>
                <?php endforeach; ?>               
                </ul>
            </dd>
...
<?php if($brand): ?> 
    <div class="list_class b_gray">
        ...
        <?php endif; ?>     
                <ul> 
                <?php if(!$bid): ?>               
                    <li><a href="<?php echo WEB_PATH; ?>/recomgoods_list/<?php echo $cid; ?>_0_<?php echo $sort; ?>" class="ClassCur bg_red">全部</a></li>
                 <?php  else: ?>  
                     <li><a href="<?php echo WEB_PATH; ?>/recomgoods_list/<?php echo $cid; ?>_0_<?php echo $sort; ?>">全部</a></li>
                <?php endif; ?>             
                <?php if(is_array($brand)) foreach($brand AS $brands): ?>             
                <?php if($brands['id'] == $bid): ?>                    
                    <li><a  href="<?php echo WEB_PATH; ?>/recomgoods_list/<?php echo $cid; ?>_<?php echo $brands['id']; ?>_<?php echo $sort; ?>" class="ClassCur bg_red"><?php echo $brands['name']; ?></a></li>
                <?php  else: ?>   
                    <li><a href="<?php echo WEB_PATH; ?>/recomgoods_list/<?php echo $cid; ?>_<?php echo $brands['id']; ?>_<?php echo $sort; ?>"><?php echo $brands['name']; ?></a></li>
                <?php endif; ?>
                <?php endforeach; ?>
                </ul>
            </dd>
    ...
    <div class="list_Sort b_gray">
        <dl>
            <dt>排序</dt>
            <dd>
                <a href="<?php echo WEB_PATH; ?>/recomgoods_list/<?php echo $cid; ?>_<?php echo $bid; ?>_1" <?php if($sort=='1'): ?> class="SortCur"<?php endif; ?>>即将揭晓</a>
                <a href="<?php echo WEB_PATH; ?>/recomgoods_list/<?php echo $cid; ?>_<?php echo $bid; ?>_2" <?php if($sort=='2'): ?> class="SortCur"<?php endif; ?>>人气</a>
                <a href="<?php echo WEB_PATH; ?>/recomgoods_list/<?php echo $cid; ?>_<?php echo $bid; ?>_3" <?php if($sort=='3'): ?> class="SortCur"<?php endif; ?>>剩余人次</a>
                <a href="<?php echo WEB_PATH; ?>/recomgoods_list/<?php echo $cid; ?>_<?php echo $bid; ?>_4" <?php if($sort=='4'): ?> class="SortCur"<?php endif; ?>>最新</a>
                <?php if($sort=='5'): ?>
                 <a href="<?php echo WEB_PATH; ?>/recomgoods_list/<?php echo $cid; ?>_<?php echo $bid; ?>_6" class="Price_Sort SortCur">价格<i></i></a>
                <?php  else: ?>
                    <?php if($sort=='6'): ?>  
                 <a href="<?php echo WEB_PATH; ?>/recomgoods_list/<?php echo $cid; ?>_<?php echo $bid; ?>_5" class="Price_Sort SortCur">价格<s></s></a>  
                 <?php  else: ?>
                  <a href="<?php echo WEB_PATH; ?>/recomgoods_list/<?php echo $cid; ?>_<?php echo $bid; ?>_5" class="Price_Sort">价格</a>    
                    <?php endif; ?>
                <?php endif; ?>               
            </dd>
        </dl>
