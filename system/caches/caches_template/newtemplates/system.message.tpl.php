...
.box{ border:5px solid #eee; width:480px; background-color:#fff;margin-top:15%;erflow:hidden;       }
.box-b{ border:1px solid #dfdbdb;width:478px;erflow:hidden;}
.box-title{ background:<?php if(isset($config['titlebg'])): ?><?php echo $config['titlebg']; ?><?php  else: ?>#db3752<?php endif; ?>;height:30px;line-height:33px;_line-height:30px;font-size: 14px;color:<?php if(isset($config['title'])): ?><?php echo $config['title']; ?><?php  else: ?>#fff<?php endif; ?>; padding:0 10px;}
...
{
    clearInterval(close_id);
    location.href = "<?php echo G_WEB_PATH; ?>";
}
...
<div class="box">
    <div class="box-b">
        ...
        <div class="box-button">
            ...
            <a class="a-1" href="javascript:;" onclick="locahome()">首页</a>
        </div>
