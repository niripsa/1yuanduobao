...
<div class="login_layout">
    <div class="login_title">
        ...
        <span>已经是会员？<a id="hylinkLoginPage" class="blue Fb" href="#">登录</a></span>
    </div>
    <div class="login_Content"> 
        <div id="divError" class="login_CMobile_Complete hidden" style="display: none;"></div>
        <div id="divNormal" class="login_CMobile_Complete hidden" style="display: block;"> 
            <?php if(($reg_message === '发送失败，请重新点击发送')): ?>
                <p><?php echo $reg_message; ?></p>
            <?php  else: ?>            
            <p><?php echo _cfg("web_name"); ?>已向您的 <span class="orange"><?php echo $useremail; ?></span> 邮箱发送了一封验证邮件，请前往收信，完成验证!</p>
            <a id="hylinkMailsB" class="login_Email_but" href="http://mail.<?php echo $emailurl['1']; ?>" target="_blank">登录邮箱完成验证</a>
            <?php endif; ?>                 
        </div>
