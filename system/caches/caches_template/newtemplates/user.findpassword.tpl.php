    ...
    <div class="login_Content">
        ...
        <div class="login_CMobile_Complete login_CEmailPal">
            ...
            <dl>
                <dt>验证码：</dt>
                <dd>
                <input id="regSN" type="text" name="txtRegSN" class="login_input_text" ajaxurl="<?php echo G_WEB_PATH; ?>/?plugin=1&api=Captcha&action=check" datatype="*4-6" nullmsg="请输入验证码！" errormsg="请输入正确的验证码！" maxlength="6" style="width:60px;"><span>
                <img src="<?php echo G_WEB_PATH; ?>/?plugin=true&api=Captcha" id="showVerifySN" alt="看不清？换一张"></span>
                </dd>
        ...
        <div class="login_Explain">
            <p>1.您若忘记注册时所用的手机号或邮箱建议您重新注册账号， <a href="<?php echo WEB_PATH; ?>/register" class="blue Fb">立即注册</a></p>
...
$("#showVerifySN").attr("data",$("#showVerifySN").attr("src"));
$("#showVerifySN").click(function(){
