...
<style>
    ...
    <div class="R-content">
        ...
        <div class="get-pro gray02 f12">您总共成功<?php echo L('html.key'); ?>获得商品 <b id="goodsCount" class="c_red"><?php echo $total; ?></b> 个
              <a href="#" id="wuliu_select">查询物流</a>
        </div>  
    <?php if(!member_get_dizhi($uid)): ?>         
        <div class="message1 f12 bg_pink b_pink">你还没有填写收货信息,请填写收货信息！ 
            <a href="<?php echo WEB_PATH; ?>/member/home/useraddress" style="font-weight:bold; color:#2af">去填写!</a>
        </div>
    <?php endif; ?> 
        ...
        <div id="tbList" class="single-C list-tab">
            ...
            <ul class="listTitle" style="background:#fff; height:80px; padding:10px 0 0 0;">
                <li class="single-img"><a target="_blank"  href="<?php echo WEB_PATH; ?>/cgdataserver/<?php echo $recd['ogid']; ?>"><img src="<?php echo G_UPLOAD_PATH; ?>/<?php echo useri_title($recd['og_title'],'g_thumb'); ?>"></a></li>
                <li class="single-xx-has"><a target="_blank" href="<?php echo WEB_PATH; ?>/cgdataserver/<?php echo $recd['ogid']; ?>" >第<?php echo $recd['oqishu']; ?>期<?php echo useri_title($recd['og_title'],'g_title'); ?></a>               
                    <br/><br/><?php if(Getships($recd['oid'],'id',3)): ?><span>物流公司:::<?php echo Getships($recd['oid'],'eid',3); ?></span>快递单号:::<?php echo Getships($recd['oid'],'ecode',3); ?><?php endif; ?>
                </li>
                <li class="sdzt">
                <?php if($recd['ofstatus']): ?>                
                <?php if($recd['ofstatus']=='1'): ?>
                <b>等待发货</b>
                <li class="single-Control"><?php if(Getships($recd['oid'],'emoney',3)): ?>￥<?php echo Getships($recd['oid'],'emoney',3); ?><?php endif; ?></li>
                <?php endif; ?>
                <?php if($recd['ofstatus']=='2'): ?>
                <b>已发货</b>
                <?php endif; ?> 
                <?php if($recd['ofstatus']=='3'): ?>
                <b>已收货</b>  
                <?php endif; ?>               
                <?php  else: ?>
                <b>无状态</b> 
