...
<style>
    ...
    <div class="R-content">
        ...
        <div class="get-pro gray02 f12">您总共购买获得商品 <b id="goodsCount" class="c_red"><?php echo $total; ?></b> 个
    ...
    <?php endif; ?> 
        ...
        <div id="tbList" class="single-C list-tab">
            ...
            <ul class="listTitle" style="background:#fff; height:80px; padding:10px 0 0 0;">
                <li class="single-img"><a target="_blank"  href="<?php echo WEB_PATH; ?>/goods/<?php echo $recd['otext']['gid']; ?>"><img src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $recd['otext']['g_thumb']; ?>"></a></li>
                <li class="single-xx-has"><a target="_blank" href="<?php echo WEB_PATH; ?>/goods/<?php echo $recd['otext']['gid']; ?>" ><?php echo $recd['otext']['g_title']; ?></a>               
                ...
                <li class="sdzt">
                <?php if(GetOrders($recd['oid'],'ofstatus')): ?>
                    <b ><?php echo GetOrders($recd['oid'],'ofstatus'); ?></b>
                <?php  else: ?>
                    <b>等待发货</b>
                <?php endif; ?>
                </li>
                <li class="single-Control"><?php if(Getships($recd['oid'],'emoney',1)): ?>￥<?php echo Getships($recd['oid'],'emoney',1); ?><?php endif; ?></li>
            </ul>
            <?php endforeach; ?>
            <?php endif; ?>
        </div>
