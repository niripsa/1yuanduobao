...
<table width="100%" class="lr10">
    ...
    <tr>
        <td width="80">模板类型</td>
        <td><?php echo $template['type']; ?>
        <span style="color: #f60"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(模板类型分为：pc、mobile 两种)</span>
        </td>
    </tr>
    <tr>
        <td width="80">模板目录</td> 
        <td><?php echo $template['dir']; ?>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td width="80">模板状态</td>
        <td><input type="text" name="status" class="input-text"  value="<?php echo $template['status']; ?>"></td>
    </tr>
</table>
    <div class="bk15"></div>
