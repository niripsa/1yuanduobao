...
//			$this->return_url = "http://".$_SERVER['HTTP_HOST']."/tpshop/index.php?m=Mobile&c=LoginApi&a=callback&oauth=qq";
//		else
//	    $this->return_url = "http://".$_SERVER['HTTP_HOST']."/tpshop/index.php?m=Home&c=LoginApi&a=callback&oauth=qq";
			
		$this->return_url = "http://".$_SERVER['HTTP_HOST']."/tpshop/index.php/Home/LoginApi/callback/oauth/qq";	
