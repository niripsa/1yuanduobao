...
function ajaxGetRegion()
{
	$.ajax({
		type : "get",
		dataType:'json',
		url:"/tpshop/index.php?m=Home&c=Goods&a=getRegion",
...
function ajaxDispatching(region_id) {
	$.ajax({
		...
		url: "/tpshop/index.php?m=Home&c=Goods&a=dispatching",
		success: function (data) {
			if (data.status == 1) {
...
//                    $.getJSONP("https://d.jd.com/area/get?callback=getAreaListcallback&fid="+cityId);
				$.getJSONP("/tpshop/index.php?m=Home&c=Goods&callback=getAreaListcallback&a=region&fid="+cityId);
			}
...
//                    $.getJSONP("https://d.jd.com/area/get?callback=getAreaListcallback&fid="+areaId);
				$.getJSONP("/tpshop/index.php?m=Home&c=Goods&callback=getAreaListcallback&a=region&fid="+areaId);
			}
