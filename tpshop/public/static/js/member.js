...
//	        window.location.href=uri + '&' + name + '=' + items;
    ...
    $('*[nc_type="gselector"]').focus(function(){
        ...
        ajax_form(id, title, SITEURL + '/tpshop/index.php?act=store_groupbuy&op=' + op + '&dialog=1&title=' + title + '&store_id=' + store_id+ '&id=' + id + '&name=' + name + '&callback=' + callback, width);
        return false;
    });
    ...
    $('span[nc_type="order_by"]').click(function(){
        ...
        location.assign(SITEURL + '/tpshop/index.php?' + params.join('&'));
    });
