<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view2/goods\goodsList.html";i:1497540707;s:44:"./application/admin/view2/public\layout.html";i:1497686826;}*/ ?>
<!doctype html>
<html>
<head>
...
<link href="/tpshop/__PUBLIC__/static/css/page.css" rel="stylesheet" type="text/css">
<link href="/tpshop/__PUBLIC__/static/font/css/font-awesome.min.css" rel="stylesheet" />
<!--[if IE 7]>
  <link rel="stylesheet" href="/tpshop/__PUBLIC__/static/font/css/font-awesome-ie7.min.css">
<![endif]-->
<link href="/tpshop/__PUBLIC__/static/js/jquery-ui/jquery-ui.min.css" rel="stylesheet" type="text/css"/>
<link href="/tpshop/__PUBLIC__/static/js/perfect-scrollbar.min.css" rel="stylesheet" type="text/css"/>
...
<script type="text/javascript" src="/tpshop/__PUBLIC__/static/js/layer/layer.js"></script><!-- 弹窗js 参考文档 http://layer.layui.com/-->
<script type="text/javascript" src="/tpshop/__PUBLIC__/static/js/admin.js"></script>
...
<script type="text/javascript" src="/tpshop/__PUBLIC__/static/js/perfect-scrollbar.min.js"></script>
<script type="text/javascript" src="/tpshop/__PUBLIC__/static/js/jquery.mousewheel.js"></script>
<script src="/tpshop/__PUBLIC__/js/myFormValidate.js"></script>
<script src="/tpshop/__PUBLIC__/js/myAjax2.js"></script>
<script src="/tpshop/__PUBLIC__/js/global.js?v=123"></script>
        ...
        <table cellspacing="0" cellpadding="0">
          <thead>
            <tr>
              ...
              <th align="center" abbr="article_time" axis="col6" class="">
                <div style="text-align: center; width: 30px;" class="" onClick="sort('is_on_sale');">上/下架</div>
              </th>
              <th align="center" abbr="article_time" axis="col6" class="">
...
<script>
    ...
    function ajax_get_table(form, page) {
        ...
        $.ajax({
            type: "POST",
            url: "/tpshop/index.php?m=Admin&c=goods&a=ajaxGoodsList&p=" + page,//+tab,
    ...
    function del_goods(goods_id,obj){
        layer.confirm('确定要删除商品吗？', {
                    ...
                    $.ajax({
                        ...
                        dataType:'json',
                        data:{id:goods_id},
                        url: "/tpshop/index.php?m=admin&c=goods&a=delGoods",
                        success: function (v) {
                            layer.closeAll();
                            if (v.status == 1){
