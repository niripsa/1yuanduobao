<style type="text/css">
.concenter-err {width: 100%;background: url(/public/images/error_pic.png);}
...
.error-pic {background: url(/public/images/404.png) no-repeat;}
  ...
  <div id="warpper" class="clearfix">
    <div class="error-page error-pic">
      ...
      <div class="error-page-btn">
      	...
      	<a href="/tpshop/index.php" class="return-index">返回首页</a>
      </div>
    </div>
   </div>
</div>
